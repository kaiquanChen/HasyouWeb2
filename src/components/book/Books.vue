            ...
            <div class="center-left">
                <div class="new-book">
                    ...
                    <div class="page-btn-dot" v-if="!checkMedia()">
                        <div class="item" :style="getStyle('BOOK_EXPRESS', index)" @click="handleExpress(index)"
                             v-for="index in Math.ceil(express_page.total / express_page.count)"></div>
                    </div>
                    <div class="page-btn">
                    ...
                    <ul class="new-book-body">
                        <li :class="getClass(index)" v-for="(item, index) in book_express" :key="item.id">
                            ...
                            <div class="info">
                                <span class="title"><a :href="gotoBookDetail(item.id)">{{item.name}}</a></span>
                                <span class="author">{{item.authors[0]}}</span>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="good-market">
                    <h2><b>畅销图书</b></h2>
                    <div class="page-btn-dot" v-if="!checkMedia()">
                        <div class="item" :style="getStyle('GOOD_MARKET', index)" @click="handleGoodMarket(index)"
                             v-for="index in Math.ceil(good_market_page.total / good_market_page.count)"></div>
                    </div>
                    <div class="page-btn">
                    ...
                    <ul class="good-market-body">
                        <li :class="getClass(index)" v-for="(item, index) in book_good_market" :key="item.id">
                            ...
                            <div class="info">
                                <div class="title"><a target="_blank" :href="gotoBookDetail(item.id)">{{item.name}}</a>
                                </div>
